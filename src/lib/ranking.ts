...
export function rankProducts(products: DemoProduct[], weights: PreferenceWeights, budgetPaise?: bigint | null, category?: string | null) {
  ...
  return products
    .filter((product) => product.availableQty > 0 && (budgetPaise == null || product.pricePaise <= budgetPaise))
